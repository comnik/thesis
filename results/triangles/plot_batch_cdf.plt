...
plot "batch/join.dat" using 1:(1-$3/STATS_max) ls 1 with lines title "Join ([a c] [b c]) [a b]",\
     "batch/dogs.dat" using 1:(1-$3/STATS_max) ls 2 with lines title "DogsDogsDogs", 

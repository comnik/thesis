...
plot "nobatch/join_ab_ac_bc.dat" using 1:(1-$3/STATS_max) ls 1 with lines title "Join ([a b] [a c]) [b c]",\
     ...
     "nobatch/dogs_ab_ac_bc.dat" using 1:(1-$3/STATS_max) ls 5 with lines title "WCO I",\
     "nobatch/dogs_ab_bc_ac.dat" using 1:(1-$3/STATS_max) ls 4 with lines title "WCO II",\
     "nobatch/dogs_bc_ac_ab.dat" using 1:(1-$3/STATS_max) ls 6 with lines title "WCO III"
